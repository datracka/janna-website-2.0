export const translations = {
  es: {
    ...
    about: {
      title: "Profesora de Alemán Certificada",
      description:
    ...
    contact: {
      ...
      location:
        "Servicio presencial en Vitoria-Gasteiz, Bilbao, Logroño y alrededores",
      online: "Clases online disponibles para toda España",
    },
    footer: {
      language: "Idioma",
  ...
  en: {
    ...
    contact: {
      ...
      social: "Social Media",
      location:
        "In-person service in Vitoria-Gasteiz, Bilbao, Logroño and surroundings",
      online: "Online classes available throughout Spain",
    },
    footer: {
      language: "Language",
  ...
  de: {
    ...
    contact: {
      ...
      location:
        "Präsenzservice in Vitoria-Gasteiz, Bilbao, Logroño und Umgebung",
      online: "Online-Unterricht für ganz Spanien verfügbar",
    },
    footer: {
      language: "Sprache",
